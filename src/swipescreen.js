...
const commands = {
    command: ['Right','Left','Down','Accept','Reject'],
        ...
        <>
          ...
          <div className="SwipeScreen">
            <div className="Question">
              ...
              <TinderCard onSwipe={onSwipe} preventSwipe={["right", "left","down","up"]}>
              ...
              <Button onClick={SpeechRecognition.startListening}>Activate Voice!</Button>
              <Button
                icon="small-cross"
